...
public class ShipDataSo : ScriptableObject
{
    [SerializeField]
    [Range(1000f, 10000f)]
    float _thrustForce = 7500f, _pitchForce = 3000f, _rollForce = 1000f, _yawForce = 2000f;

    [SerializeField]
    private int _shieldStrength = 5000, _shieldRegenAmount = 100, _maxHealth = 5000;

    [SerializeField][Range(10, 1000)] int _blasterDamage = 100;

    [Range(5000f, 25000f)]
    [SerializeField] int _blasterLaunchForce = 10000;
    [SerializeField] float _blasterCoolDown = 0.25f;
    [SerializeField][Range(2f, 10f)] float _blasterProjectileDuration = 2f;
